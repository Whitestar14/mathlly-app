...
<template>
  ...
  >
    ...
    >
      <div
        class="w-full bg-white dark:bg-gray-800 shadow-xl rounded-lg overflow-hidden transition-colors duration-300"
      >
        <div class="p-6">
...
const formatResult = (result) => {
  if (settings.value.useFractions) {
    ...
    if (settings.value.useThousandsSeparator) {
      // Only apply thousands separator to the integer part
